...
/// Adds pattern-matching-related methods to [TestTool].
extension TestToolPatterns on TestTool {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TestTool value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TestTool() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TestTool value)  $default,){
final _that = this;
switch (_that) {
case _TestTool():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TestTool value)?  $default,){
final _that = this;
switch (_that) {
case _TestTool() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String title,  String id,  String description,  String value,  List<TestToolParameter>? parameters)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestTool() when $default != null:
return $default(_that.name,_that.title,_that.id,_that.description,_that.value,_that.parameters);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String title,  String id,  String description,  String value,  List<TestToolParameter>? parameters)  $default,) {final _that = this;
switch (_that) {
case _TestTool():
return $default(_that.name,_that.title,_that.id,_that.description,_that.value,_that.parameters);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String title,  String id,  String description,  String value,  List<TestToolParameter>? parameters)?  $default,) {final _that = this;
switch (_that) {
case _TestTool() when $default != null:
return $default(_that.name,_that.title,_that.id,_that.description,_that.value,_that.parameters);case _:
  return null;
...
/// Adds pattern-matching-related methods to [TestToolParameter].
extension TestToolParameterPatterns on TestToolParameter {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TestToolParameter value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TestToolParameter() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TestToolParameter value)  $default,){
final _that = this;
switch (_that) {
case _TestToolParameter():
return $default(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TestToolParameter value)?  $default,){
final _that = this;
switch (_that) {
case _TestToolParameter() when $default != null:
return $default(_that);case _:
...
switch (_that) {
case _TestToolParameter():
return $default(_that.name,_that.description,_that.type);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
