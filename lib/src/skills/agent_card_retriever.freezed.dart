...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String version,  String description,  List<Skill>? skills,  List<String>? defaultInputModes,  List<String>? defaultOutputModes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AgentCard() when $default != null:
return $default(_that.name,_that.version,_that.description,_that.skills,_that.defaultInputModes,_that.defaultOutputModes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String version,  String description,  List<Skill>? skills,  List<String>? defaultInputModes,  List<String>? defaultOutputModes)  $default,) {final _that = this;
switch (_that) {
case _AgentCard():
return $default(_that.name,_that.version,_that.description,_that.skills,_that.defaultInputModes,_that.defaultOutputModes);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String version,  String description,  List<Skill>? skills,  List<String>? defaultInputModes,  List<String>? defaultOutputModes)?  $default,) {final _that = this;
switch (_that) {
case _AgentCard() when $default != null:
return $default(_that.name,_that.version,_that.description,_that.skills,_that.defaultInputModes,_that.defaultOutputModes);case _:
  return null;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String id,  String description,  List<String>? tags,  List<String>? inputModes,  List<String>? outputModes,  List<String>? examples)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Skill() when $default != null:
return $default(_that.name,_that.id,_that.description,_that.tags,_that.inputModes,_that.outputModes,_that.examples);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String id,  String description,  List<String>? tags,  List<String>? inputModes,  List<String>? outputModes,  List<String>? examples)  $default,) {final _that = this;
switch (_that) {
case _Skill():
return $default(_that.name,_that.id,_that.description,_that.tags,_that.inputModes,_that.outputModes,_that.examples);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String id,  String description,  List<String>? tags,  List<String>? inputModes,  List<String>? outputModes,  List<String>? examples)?  $default,) {final _that = this;
switch (_that) {
case _Skill() when $default != null:
return $default(_that.name,_that.id,_that.description,_that.tags,_that.inputModes,_that.outputModes,_that.examples);case _:
  return null;
