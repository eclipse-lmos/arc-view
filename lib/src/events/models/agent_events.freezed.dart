...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  String payload,  String? conversationId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AgentEvent() when $default != null:
return $default(_that.type,_that.payload,_that.conversationId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  String payload,  String? conversationId)  $default,) {final _that = this;
switch (_that) {
case _AgentEvent():
return $default(_that.type,_that.payload,_that.conversationId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  String payload,  String? conversationId)?  $default,) {final _that = this;
switch (_that) {
case _AgentEvent() when $default != null:
return $default(_that.type,_that.payload,_that.conversationId);case _:
  return null;
