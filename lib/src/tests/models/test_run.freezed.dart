...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TestCase testCase,  bool? success,  Conversation conversation,  DateTime startedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestRun() when $default != null:
return $default(_that.testCase,_that.success,_that.conversation,_that.startedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TestCase testCase,  bool? success,  Conversation conversation,  DateTime startedAt)  $default,) {final _that = this;
switch (_that) {
case _TestRun():
return $default(_that.testCase,_that.success,_that.conversation,_that.startedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TestCase testCase,  bool? success,  Conversation conversation,  DateTime startedAt)?  $default,) {final _that = this;
switch (_that) {
case _TestRun() when $default != null:
return $default(_that.testCase,_that.success,_that.conversation,_that.startedAt);case _:
  return null;
