...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ProfileEntry> profile,  String userId,  String? userToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserContext() when $default != null:
return $default(_that.profile,_that.userId,_that.userToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ProfileEntry> profile,  String userId,  String? userToken)  $default,) {final _that = this;
switch (_that) {
case _UserContext():
return $default(_that.profile,_that.userId,_that.userToken);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ProfileEntry> profile,  String userId,  String? userToken)?  $default,) {final _that = this;
switch (_that) {
case _UserContext() when $default != null:
return $default(_that.profile,_that.userId,_that.userToken);case _:
  return null;
