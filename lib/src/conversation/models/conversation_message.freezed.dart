...
@override List<String>? get toolCalls {
...
/// Adds pattern-matching-related methods to [BinaryData].
extension BinaryDataPatterns on BinaryData {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BinaryData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _BinaryData() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BinaryData value)  $default,){
final _that = this;
switch (_that) {
case _BinaryData():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BinaryData value)?  $default,){
final _that = this;
switch (_that) {
case _BinaryData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? dataAsBase64,  String mimeType,  String? source)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BinaryData() when $default != null:
return $default(_that.dataAsBase64,_that.mimeType,_that.source);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? dataAsBase64,  String mimeType,  String? source)  $default,) {final _that = this;
switch (_that) {
case _BinaryData():
return $default(_that.dataAsBase64,_that.mimeType,_that.source);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? dataAsBase64,  String mimeType,  String? source)?  $default,) {final _that = this;
switch (_that) {
case _BinaryData() when $default != null:
return $default(_that.dataAsBase64,_that.mimeType,_that.source);case _:
  return null;
